          ...
          child: BackdropFilter(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: Border(top: BorderSide(color: const Color(0xFF334155).withOpacity(0.8), width: 0.5)),
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('More', style: GoogleFonts.poppins(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w700)),
        ...
        child: InkWell(
          ...
          onTap: () => Navigator.push(ctx, MaterialPageRoute(builder: (_) => Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(title, style: GoogleFonts.poppins(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w600)),
            ),
